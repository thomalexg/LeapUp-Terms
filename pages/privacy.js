export default function Privacy() {
  return (
    <p>
      **Privacy Policy** built the LeapUp app as a Free app. This SERVICE is
      provided by at no cost and is intended for use as is. This page is used to
      ...
      our Terms and Conditions, which is accessible at LeapUp unless otherwise
      defined in this Privacy Policy. **Information Collection and Use** For a
      better experience, while using our Service, I may require you to provide
      us with certain personally identifiable information. The information that
      I request will be retained on your device and is not collected by me in
      any way. The app does use third party services that may collect
      information used to identify you. Link to privacy policy of third party
      service providers used by the app * [Google Play
      Services](https://www.google.com/policies/privacy/) **Log Data** I want to
      inform you that whenever you use my Service, in a case of an error in the
      app I collect data and information (through third party products) on your
      ...
      and date of your use of the Service, and other statistics. **Cookies**
      ...
      to disclose or use the information for any other purpose. **Security** I
      ...
      under the age of 13. I do not knowingly collect personally identifiable
      information from children under 13 years of age. In the case I discover
      that a child under 13 has provided me with personal information, I
      ...
      actions. **Changes to This Privacy Policy** I may update our Privacy
      ...
      2021-04-26 **Contact Us** If you have any questions or suggestions about
      my Privacy Policy, do not hesitate to contact me at leapupapp@gmail.com.
